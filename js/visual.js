...
(function() {
  ...
  var HIGH_THRESHOLD = 0.9;
  var AMPLITUDE_SAMPLES = 1024;
  var N_STARS = 300;
  var PARALLAX_AMOUNT = 0.2;
  //var MUSIC_NUMBER = Math.random() * 11 | 0;
  var MUSIC_LIST = ['./music/1.mp3', './music/2.mp3', './music/3.mp3', './music/4.mp3', './music/5.mp3', './music/6.mp3', './music/7.mp3', './music/8.mp3', './music/9.mp3', './music/10.mp3', './music/11.mp3']
  ...
  function updateFrequencies() {
    ...
    //console.log(audio)
    //console.log(low.toFixed(4), mid.toFixed(4), high.toFixed(4))
  }

...
!function(e) {
    ...
    function f(e, t, n, o, i) {
        ...
        o)
            for (var s in o)
                o.hasOwnProperty(s) && r.setRequestHeader(s, o[s]);
        r.withCredentials = !0,
        r.send(i)
    }
    function p(e) {
...
, function(e, t, n) {
    ...
    var a = function() {
        ...
        (n = [{
            ...
            key: "userIsLoggedIn",
            value: function() {
                this.show("wm-save-snapshot-open"),
                this.hide("wm-sign-in")
            }
        }, {
            key: "userIsNotLoggedIn",
            value: function() {
                this.hide(["wm-save-snapshot-open", "wm-save-snapshot-in-progress"]),
...
, , , , , , , function(e, t, n) {
    ...
    function m(e, t, n) {
        ...
        var a = [];
        function u(e, n) {
            var o, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "src", r = window.location.origin, s = b(window, e), l = p(s);
            try {
                for (l.s(); !(o = l.n()).done; ) {
                    var u = o.value;
                    if (!n || n(u)) {
                        ...
                        var n = document.createElement("span")
                          , a = function(e, t) {
                            ...
                            var h = Math.floor(n / 1e3)
                              , f = [];
                            s > 1 ? (f.push(s + " years"),
                            i = !0) : 1 == s && (f.push(s + " year"),
                            i = !0);
                            a > 1 ? (f.push(a + " months"),
                            i = !0) : 1 == a && (f.push(a + " month"),
                            i = !0);
    ...
    function v(e, t) {
        for (var n = t.split("/").splice(6).join("/"), o = e.document.querySelectorAll("img[src$='" + n + "'], iframe[src$='" + n + "'], frame[src$='" + n + "']"), i = Array.prototype.slice.call(o), r = 0; r < e.frames.length; r++)
            try {
    ...
    function y(e) {
        ...
        if (t.length > 0)
            for (var n = 0; n < t.length; n++)
                g(t[n]).classList.add("wb-highlight")
    }
    function w(e) {
        var t = v(window, e.target.href);
        if (t.length > 0)
    ...
    function b(e, t) {
        for (var n = e.document.getElementsByTagName(t), o = Array.prototype.slice.call(n), i = 0; i < e.frames.length; i++)
            try {
    ...
    var L, O, E = function() {
        ...
        return T(e, [{
            ...
            value: function(e) {
                ...
                if ((40 == o || 38 == o) && this.sc.innerHTML)
                    return (i = this.sc.querySelector(".wb-autocomplete-suggestion.selected")) ? (t = 40 == o ? i.nextSibling : i.previousSibling) ? (i.className = i.className.replace("selected", ""),
                    t.className += " selected",
                    this.input.value = t.getAttribute("data-val")) : (i.className = i.className.replace("selected", ""),
                ...
                if (27 == o)
                    ...
                    var i;
                    (i = this.sc.querySelector(".wb-autocomplete-suggestion.selected")) && "none" != this.sc.style.display && (this.onSelect(e, i.getAttribute("data-val"), i),
                    setTimeout((function() {
        ...
        e
    }(), R = n(2), A = window.JSON, N = window.open, U = window.Date, I = document, D = document, P = function(e) {
        return D.getElementById(e)
    };
    var q, F = "/static/";
    function B(e) {
        L.classList.contains("wm-closed") ? (e && O.classList.add("notice-only"),
        L.classList.replace("wm-closed", "wm-open"),
        O.style.display = "block",
        m(q, F, P)) : (L.classList.replace("wm-open", "wm-closed"),
    ...
    function $(e, t, n) {
        !function(e, t) {
            ...
            console.log("screen shot delta: " + r + "s"),
            n(r > 0 && r < 60, r)
        }
        ))
    }
    window.__wm = {
        ...
        bt: function(e, t, n, o, i, r, s, a, p, d, m) {
            F = p || "/static/",
            q = s;
            var v, g, y, w = "/" + (i || "web") + "/", b = l.c(q), _ = b.getUTCFullYear(), S = b.getUTCMonth() + 1, M = b.getUTCDate(), T = -1, k = -1, C = P("wm-ipp-base");
            if (C.attachShadow) {
                var x = C.attachShadow({
                    mode: "closed"
                });
                for (D = x; C.children.length > 0; )
                    x.appendChild(C.children[0]);
                if (d)
            ...
            P("wm-tb-close").addEventListener("click", (function(e) {
                P("wm-ipp-inside").style.display = "none",
                e.preventDefault(),
                W()
            }
            ));
            ...
            V.onmousemove = function(t) {
                ...
                s = I.documentElement,
                ("undefied" != typeof i.getBoundingClientRect ? i.getBoundingClientRect() : {
                    top: 0,
                    left: 0
                }).left + (window.pageXOffset || s.scrollLeft) - (s.clientLeft || 0)), p = Math.min(Math.max(0, u - f), e), d = p % n, m = Math.floor(p / n), v = Math.min(11, Math.floor(d / o)), b = 12 * m + v, _ = d % 2 == 1 ? 15 : 1, S = h(m + a) + h(v + 1, 2) + h(_, 2) + "000000";
                P("displayYearEl").innerHTML = m + a,
                P("displayMonthEl").innerHTML = l.b(v);
                var M = w + S + "/" + r;
                if (P("wm-graph-anchor").href = M,
                T != m) {
                    var C = m * n;
                    g.style.left = C + "px",
                    T = m
            ...
            if (Z.getContext && Z.getContext("2d")) {
                    ...
                    if (200 == n.status) {
                        ...
                        !function(e) {
                            for (var t = P("wm-nav-captures"), n = 0, o = e.years, i = e.first_ts, s = e.last_ts, a = 0; a < o.length; a++)
                                for (var c = o[a][1], u = 0; u < c.length; u++)
                                    n += c[u];
                            ...
                            if (a) {
                                ...
                                for (var g = (l - 1) / 12, y = 0; y < p.length; y++) {
                                    ...
                                    for (var w = p[y][1], b = T(v) + 1, _ = 0; _ < 12; _++) {
                                        ...
                                        if (S > 0) {
                                            var M = Math.ceil(S * d);
                                            a.fillStyle = v == r && _ == s ? "#EC008C" : "#000",
                                            a.fillRect(Math.round(b), Math.ceil(n - M), Math.ceil(g), Math.round(M))
                                        }
                                        b += g
                                    }
                                }
                ...
                var te = new Image;
                te.src = "/__wb/sparkline?url=" + encodeURIComponent(r) + "&width=" + e + "&height=" + t + "&selected_year=" + _ + "&selected_month=" + S + (i && "&collection=" + i || ""),
                te.alt = "sparkline",
                te.width = e,
                te.height = t,
                ...
                source: function(e, t) {
                    Object(c.a)("GET", "/__wb/search/host?q=" + encodeURIComponent(e), (function(n) {
                        if (void 0 !== (n = A.parse(n.response)).hosts && n.hosts.length > 0) {
                            ...
                            void 0 !== n.isUrl && !0 === n.isUrl && void 0 === n.excluded ? t([e]) : Object(c.a)("GET", "/__wb/search/anchor?q=" + encodeURIComponent(e), (function(e) {
            ...
            P("wmtb").onsubmit = function(e) {
                ...
                if (0 !== t.indexOf("http://") && 0 !== t.indexOf("https://") && !t.match(/[\w\.]{2,256}\.[a-z]{2,4}/gi))
                    return document.location.href = "/web/*/" + P("wmtbURL").value,
                    e.preventDefault(),
                    !1
            }
            ,
            function(e, t) {
                $(e, t, (function(e, t) {
                    e ? (P("wm-screenshot").title = "screen shot (delta: " + t + "s)",
